...
const Slots = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div cla4ssName="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {slots.map((slot) => (
  ...
  {slot.doctorId?.name || "Unknown Doctor"}
</h3>              <p className="text-blue-800">{slot.doctorId.specialization}</p>
            </div>
